...
namespace WebApplication11.Models
{
    public class BookService : IBook
    {
        ...
        List<Book> IBook.GetBookByAuthor(string auth)
        {
            List<Book> list = new List<Book>();
        ...
        List<Book> IBook.GetBookByCategory(string CatName)
        {
            List<Book> list = new List<Book>();
        ...
        Book IBook.GetBookByISBN(int Isbn)
        {
        ...
        List<Book> IBook.GetBookByName(string name)
        {
            List<Book> list = new List<Book>();
